...
typedef enum dat_system {
    ...
    dat_ads_ombias_x,             ///< Attitude omega bias estimation (body)
    dat_ads_ombias_y,             ///< Attitude omega bias estimation (body)
    dat_ads_ombias_z,             ///< Attitude omega bias estimation (body)
